...
<div class="flex flex-col justify-center">
	...
	<p class="mt-3 text-center text-4xl">Première<br />manche</p>
	<p class="mt-20 text-center text-2xl">C'est au tour de :</p>

	<div class="flex justify-center mt-1">
		<TeamTag team={speaker.team} />
	</div>

	<p class="mt-4 text-center text-2xl">avec :</p>
	...
	{#if isSpeaker}
		<div class="flex justify-center absolute bottom-28 w-full">
			<Button on:click={startTurn}>Ready ? Go !</Button>
		</div>
	{/if}
</div>
